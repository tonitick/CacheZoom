...
sudo taskset -c 0 ./cachezoom 0 `sudo cat /proc/kallsyms | grep "t lapic_next_deadline" | awk '{print $1}'` `sudo cat /proc/kallsyms | grep "local_apic_timer_interrupt" | awk '{print $1}'` 4815 1
